  ...
  return (
    <div className="w-full min-h-screen bg-white overflow-y-auto">
      ...
      <div className="flex flex-col items-center w-full pt-[0vh] px-[5vw] pb-[10vh] overflow-y-auto">
        ...
        {/* 퍼센트 박스 */}
        <div className="flex flex-row gap-16 items-center mt-[4vh] mb-[3vh]">
          {/* 이전 대화 */}
          <div className="flex flex-col items-center">
            <span className="text-[1.2vw] text-gray-500 mb-2">이전 대화</span>
            <div className="w-[150px] h-[150px] rounded-full bg-gray-100 flex items-center justify-center shadow-lg">
              <span className="text-[4vw] font-bold text-[#FF6E75]">
                {previousPercent !== null ? previousPercent : '-'}%
              </span>
            </div>
            <span className="text-[1vw] text-gray-400 mt-2">
          ...
          {/* 최신 대화 */}
          <div className="flex flex-col items-center">
            <span className="text-[1.2vw] text-gray-500 mb-2">최신 대화</span>
            <div className="w-[150px] h-[150px] rounded-full bg-[#FF6E75]/[.15] flex items-center justify-center shadow-lg">
              <span className="text-[4vw] font-bold text-[#FF6E75]">
                {latestPercent}%
              </span>
            </div>
